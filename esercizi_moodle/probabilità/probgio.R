...
| Sia X una variabile aleatoria continua distribuita come una Uniforme sullintervallo [0,1].
Determinare:

1. La probabilità che X sia minore della sua media. => LA MEDIA SONO I VALORI INTERV. SOMMATI E DIVISI PER 2 !!
> punif(1/2, 0, 1) = 0.5
